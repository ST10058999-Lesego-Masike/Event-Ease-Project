...
namespace EventEaseProject.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(EEDbContext context)
        {
            _context = context;
        }
        ...
        {
            var eEDbContext = _context.Bookings.Include(b => b.Event).Include(b => b.Venue);
            return View(await eEDbContext.ToListAsync());
        }
